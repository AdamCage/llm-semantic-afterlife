...
**Generate is not authorised.** CLI estimate **$2.47** (fill=1);
S2.2-calibrated fill 0.65 is **$3.33**. Wait for a yes.

| pass | status |
| --- | --- |
| S4.0 reuse S2.2 raw `W=4096` T=0.3, 1.0 (8 traj) | cells exist; not yet joined into stage-4 artifacts |
| S4.1 `stage4_w4096_new_temps.yaml` (8 traj) | planned; not generated |
| S4.2 `stage4_w8192.yaml` (16 traj) | planned; not generated |
