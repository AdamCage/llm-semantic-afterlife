...
twelve turnovers of $W{=}4096$, and last-band occupancy still carries seed-domain
identity in three embedding spaces. % artifacts/stage-5/occupancy/lock_rate_by_seed.csv @ s5-lock-occupancy-20260905T164327Z-6780902f
...
separates seed domains and whether replica pairs collapse. Those occupancy
signs hold in three embedding spaces on this generator, protocol, and
temperature. % artifacts/stage-6/occupancy/domain_separation_last_band.csv @ s6-embed-third-space-20260906T082301Z-588eff8f
...
\texttt{or-qwen3-8b} (Qwen3-8B-Instruct via OpenRouter), $W{=}4096$,
...
The input at each step is the last $W$ tokens of generated text, re-encoded
and sent as a new prompt (P1). That is not a sliding native KV cache. The
...
F4 and F6 are \texttt{or-qwen3-8b}, P1, $T{=}0.3$, $W{=}4096$. % docs/stages/stage-5/REPORT.md @ s5-lock-occupancy-20260905T164327Z-6780902f
...
still separate ten seed domains in three embedding spaces; replica $\Delta$
